...
同时提出 **DirectMe** 框架，通过增量构建并维护结构化的空间记忆，实现相对于用户运动的物体位置追踪与回忆。实验表明 DirectMe 显著提升了主流多模态大语言模型的空间推理能力，并超越了多个空间感知与长序列视频模型。代码与数据已开源：https://github.com/cocowy1/UCS-Bench。
